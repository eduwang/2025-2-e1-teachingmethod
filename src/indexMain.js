...
const allowedAdmins = ["B5zjH8Bg2LXI1WQjWuDH7KKjpEG3", 'pkxmgz9Tr4gnwJm4lNn1iangTSf2', '0amEKTRAzJMvsAq5qJ78bru0GId2']; // 🔐 여기에 관리자 UID 넣기
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (user) {
    ...
    const pageLPEBtn = `<a href="/pageLessonPlayEnhanced.html" class="nav-button">🧩 Lesson Play Enhanced시작하기 (Enhanced)</a>`;
